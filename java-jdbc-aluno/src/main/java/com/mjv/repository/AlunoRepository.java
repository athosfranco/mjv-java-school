...
import com.mjv.jdbc.bancoConexao;
...
public class AlunoRepository {
	...
	public void registrar(Aluno aluno) throws Exception {
		...
		String sql = "INSERT INTO tb_aluno (nome, altura, sexo, ativo)" + " VALUES(?,?,?,?)";
	...
	public void update(Aluno aluno, int id) throws Exception {
		...
		String sql = "UPDATE tb_aluno SET nome = ?, altura = ?, sexo = ?, ativo = ?" + " WHERE id = ?";
